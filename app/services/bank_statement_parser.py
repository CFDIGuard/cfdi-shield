...
HEADER_ALIASES = {
    "fecha": {"fecha", "fecha_operacion", "fecha movimiento", "fecha_movimiento"},
    "descripcion": {"descripcion", "descripcion movimiento", "concepto", "detalle", "movimiento"},
    "referencia": {"referencia", "ref", "folio", "uuid", "referencia bancaria"},
    "cargo": {"cargo", "retiro", "egreso", "debito"},
    "abono": {"abono", "deposito", "ingreso", "credito"},
    "monto": {"monto", "importe", "total", "amount"},
